...
: Actor(game)
{
	...
	std::vector<SDL_Texture*> idle{GetGame()->GetTexture("Assets/Cat/Idle.png")};
	asc->AddAnimation("idle", idle);
	std::vector<SDL_Texture*> dead{GetGame()->GetTexture("Assets/Cat/Dead.png")};
	asc->AddAnimation("dead", dead);
	std::vector<SDL_Texture*> jumpLeft{GetGame()->GetTexture("Assets/Cat/JumpLeft.png")};
	asc->AddAnimation("jumpLeft", jumpLeft);
	std::vector<SDL_Texture*> jumpRight{GetGame()->GetTexture("Assets/Cat/JumpRight.png")};
	asc->AddAnimation("jumpRight", jumpRight);
	std::vector<SDL_Texture*> runLeft{GetGame()->GetTexture("Assets/Cat/RunLeft0.png")};
									  /*GetGame()->GetTexture("Assets/Mario/RunLeft1.png"),
									  GetGame()->GetTexture("Assets/Mario/RunLeft2.png")};*/
	asc->AddAnimation("runLeft", runLeft);
	std::vector<SDL_Texture*> runRight{GetGame()->GetTexture("Assets/Cat/RunRight0.png")};
